...
feet varchar(3) , flipFlag boolean , unitFlag boolean , decimalFlag boolean , feetFlag boolean , lColor varchar(10) , rColor varchar(10) )';
...
//echo updateLang1Value($con,'URDU');
